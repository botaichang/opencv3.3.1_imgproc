...
int main()
{
    ...
    //cv::createTrackbar($`const cv::String &trackbarname`, $`const cv::String &winname`, $`int *value`, $`int count`);
...
void on_high_b_thresh_trackbar(int, void *)
{
    ...
    //cv::setTrackbarPos($`const cv::String &trackbarname`, $`const cv::String &winname`, $`int pos`)
}
